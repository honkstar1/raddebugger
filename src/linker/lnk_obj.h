...
internal void                 lnk_obj_apply_relocs_to_buffer(LNK_Obj *obj, U64 sect_idx, COFF_SectionHeader *section_header, String8 section_data, U64 image_base, COFF_SectionHeader **image_section_table);
